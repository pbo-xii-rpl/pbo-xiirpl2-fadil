...
export default function App() {
    return (
    <nav className="navbar bg-indigo-600 py-12">
      ...
      <div>
      <div className="text-5xl my-12 mt-20 font-mono text-white text-center leading-relaxed">Saya seorang front-end engineer, back-end <br/>engineer, dan juga UI designer</div>
